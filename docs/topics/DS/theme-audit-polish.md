...
**Corrección de framing (post-debate):** el destinatario no es un lab estudiantil; es una **propuesta / PoC para Komatsu**. Se mantienen los recortes técnicos del debate (reserva de stock, medición, madurez de arquitectura) reinterpretados como plan de entrega empresarial.
