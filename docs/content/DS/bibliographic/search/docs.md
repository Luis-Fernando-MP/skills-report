# Búsqueda bibliográfica — DS

## theory-factors-continuous-experimentation-face

- **Título:** A Theory of Factors Affecting Continuous Experimentation (FACE)
- **Autores:** Rasmus Ros, Elizabeth Bjarnason, Per Runeson
- **Keywords:** continuous experimentation; lean startup; lean canvas; software engineering; theory
