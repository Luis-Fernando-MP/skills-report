---
title: "Distributed Transactions in Microservice Architecture: Informed Decision-Making Strategies"
authors: "Artem Bashtovyi, Andrii Fechan"
year: 2024
doi_url: "https://doi.org/10.23939/sisn2024.15.449"
...
enriched_at: 2026-09-06T03:52:19+00:00
---
...
- DOI: `https://doi.org/10.23939/sisn2024.15.449`
- Pages: `11`
- Technique: `section-chunks + finding-hooks + es-aliases`
...
|------|-------|----------|
| abstract | Abstract | 1 |
| finding | In this paper, through experiments comparing microservices and monolithic systems, the imp… | 1 |
| hallazgo | In this paper, through experimentos comparan microservicios and sistemas monolíticos, the … | 1 |
| finding | There are some benefits of incorporating microservices instead of a single server, however… | 1 |
| hallazgo | There are some benefits of incorporating microservicios instead of a single server, howeve… | 1 |
| finding | Distributed transactions are one of the solutions for ensuring data consistency across ser… | 1 |
| hallazgo | transacciones distribuidas are one of the solutions for ensuring data consistencia across … | 1 |
| finding | Regardless of effectiveness distributed transactions entail different trade-offs and perfo… | 1 |
| hallazgo | Regardless of effectiveness transacciones distribuidas entail different trade-offs and ren… | 1 |
| finding | The emergence of microservice architecture has revolutionized software development practic… | 1 |
| hallazgo | The emergence of microservicio architecture has revolutionized software development practi… | 1 |
| finding | As microservices interact independently, coordinating data updates across multiple service… | 1 |
| hallazgo | As microservicios interact independently, coordinating data updates across multiple servic… | 1 |
| finding | Those trade-offs are not always justified. | 1 |
| finding | This study highlights the need for a nuanced understanding of distributed transactions in … | 1 |
| hallazgo | This study highlights the need for a nuanced understanding of transacciones distribuidas i… | 1 |
| finding | It also represents existing solutions to the different distributed transaction methods. | 1 |
| hallazgo | It also represents existing solutions to the different transacción distribuida methods. | 1 |
| finding | This research also contributes to enhancing understanding and decision-making regarding th… | 1 |
| hallazgo | This research also contributes to enhancing understanding and decision-making regarding th… | 1 |
...
### [PDF p.1] Finding: In this paper, through experiments comparing microservices and monolithic systems, the impact of distributed transactions on system performance is evaluated, giving intuition about consequences when a single data source transaction is migrated to the distributed environment.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

In this paper, through experiments comparing microservices and monolithic systems, the impact of distributed transactions on system performance is evaluated, giving intuition about consequences when a single data source transaction is migrated to the distributed environment.

### [PDF p.1] Hallazgo: In this paper, through experimentos comparan microservicios and sistemas monolíticos, the impact of transacciones distribuidas on system rendimiento is evaluated, giving intuition about consequences when a single data source transaction is migrated to the distributed environment.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

In this paper, through experimentos comparan microservicios and sistemas monolíticos, the impact of transacciones distribuidas on system rendimiento is evaluated, giving intuition about consequences when a single data source transaction is migrated to the distributed environment.

### [PDF p.1] Finding: There are some benefits of incorporating microservices instead of a single server, however, distributed components introduce extra constraints and complexities in maintaining data consistency as well.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

There are some benefits of incorporating microservices instead of a single server, however, distributed components introduce extra constraints and complexities in maintaining data consistency as well.

### [PDF p.1] Hallazgo: There are some benefits of incorporating microservicios instead of a single server, however, distributed components introduce extra constraints and complexities in maintaining data consistencia as well.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

There are some benefits of incorporating microservicios instead of a single server, however, distributed components introduce extra constraints and complexities in maintaining data consistencia as well.

### [PDF p.1] Finding: Distributed transactions are one of the solutions for ensuring data consistency across services.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

Distributed transactions are one of the solutions for ensuring data consistency across services.

### [PDF p.1] Hallazgo: transacciones distribuidas are one of the solutions for ensuring data consistencia across services.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

transacciones distribuidas are one of the solutions for ensuring data consistencia across services.

### [PDF p.1] Finding: Regardless of effectiveness distributed transactions entail different trade-offs and performance implications.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

Regardless of effectiveness distributed transactions entail different trade-offs and performance implications.

### [PDF p.1] Hallazgo: Regardless of effectiveness transacciones distribuidas entail different trade-offs and rendimiento implications.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

Regardless of effectiveness transacciones distribuidas entail different trade-offs and rendimiento implications.

### [PDF p.1] Finding: The emergence of microservice architecture has revolutionized software development practices by decentralizing components, facilitating scalability, and enabling agility in system design and deployment.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

The emergence of microservice architecture has revolutionized software development practices by decentralizing components, facilitating scalability, and enabling agility in system design and deployment.

### [PDF p.1] Hallazgo: The emergence of microservicio architecture has revolutionized software development practices by decentralizing components, facilitating scalability, and enabling agility in system design and deployment.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

The emergence of microservicio architecture has revolutionized software development practices by decentralizing components, facilitating scalability, and enabling agility in system design and deployment.

### [PDF p.1] Finding: As microservices interact independently, coordinating data updates across multiple services becomes challenging, particularly in scenarios where transactional integrity is required.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

As microservices interact independently, coordinating data updates across multiple services becomes challenging, particularly in scenarios where transactional integrity is required.

### [PDF p.1] Hallazgo: As microservicios interact independently, coordinating data updates across multiple services becomes challenging, particularly in scenarios where transactional integrity is required.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

As microservicios interact independently, coordinating data updates across multiple services becomes challenging, particularly in scenarios where transactional integrity is required.

### [PDF p.1] Finding: Those trade-offs are not always justified.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

Those trade-offs are not always justified.

### [PDF p.1] Finding: This study highlights the need for a nuanced understanding of distributed transactions in microservices by revisiting challenges in managing distributed transactions within data storage systems.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

This study highlights the need for a nuanced understanding of distributed transactions in microservices by revisiting challenges in managing distributed transactions within data storage systems.

### [PDF p.1] Hallazgo: This study highlights the need for a nuanced understanding of transacciones distribuidas in microservicios by revisiting challenges in managing transacciones distribuidas within data storage systems.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

This study highlights the need for a nuanced understanding of transacciones distribuidas in microservicios by revisiting challenges in managing transacciones distribuidas within data storage systems.

### [PDF p.1] Finding: It also represents existing solutions to the different distributed transaction methods.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

It also represents existing solutions to the different distributed transaction methods.

### [PDF p.1] Hallazgo: It also represents existing solutions to the different transacción distribuida methods.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

It also represents existing solutions to the different transacción distribuida methods.

### [PDF p.1] Finding: This research also contributes to enhancing understanding and decision-making regarding the utilization of distributed transactions in a microservices architecture.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1**

This research also contributes to enhancing understanding and decision-making regarding the utilization of distributed transactions in a microservices architecture.

### [PDF p.1] Hallazgo: This research also contributes to enhancing understanding and decision-making regarding the utilization of transacciones distribuidas in a microservicios architecture.
- Locator: `bibliography/auto/pdfs/distributed-transactions-microservice-architecture.pdf` · página **1** · alias ES

This research also contributes to enhancing understanding and decision-making regarding the utilization of transacciones distribuidas in a microservicios architecture.
